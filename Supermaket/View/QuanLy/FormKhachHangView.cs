...
namespace Supermaket.View
{
    ...
    public partial class FormKhachHangView : MauView
    {
        ...
        public void LoadData()
        {
            ...
            N'%" + txtTk.Text + "%' OR LOAIKH LIKE  N'%" + txtTk.Text + "%' OR SĐT LIKE  N'%" + txtTk.Text + "%' OR DIACHI LIKE  N'%" + txtTk.Text + "%'";
            ...
            data.Columns[9].HeaderText = "Điểm thưởng";
            data.Columns[9].Width = 300;
        ...
        public override void data_DoubleClick(object sender, EventArgs e)
        {
            ...
            themkh.sdt = data.CurrentRow.Cells["SĐT"].Value.ToString();
            themkh.txtgmail.Text = data.CurrentRow.Cells["dgvgmail"].Value.ToString();
            themkh.gmail = data.CurrentRow.Cells["dgvgmail"].Value.ToString();
